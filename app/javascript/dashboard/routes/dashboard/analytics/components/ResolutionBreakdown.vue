  ...
  return [
    {
      key: 'sin_stock',
      label: 'Sin stock',
      count: byReason.sin_stock || 0,
      color: 'amber',
    },
    {
      key: 'precio',
      label: 'Precio',
      count: byReason.precio || 0,
      color: 'iris',
    },
    {
      key: 'sin_respuesta',
      label: 'Sin respuesta',
      count: byReason.sin_respuesta || 0,
      color: 'slate',
    },
    ...
    <div class="flex items-center justify-between mb-4">
      <div>
        ...
        <p class="text-xs text-n-slate-10 mt-0.5">
          Últimos 30 días · {{ totalResolved }} total
        </p>
      </div>
    </div>
    ...
    <div v-else class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        <div class="flex items-center gap-3">
          ...
          <span class="text-xs font-medium text-n-teal-11 w-12 text-right">
            {{ ganadoCount }}
          </span>
        </div>
      ...
      <div v-if="perdidoReasons.length > 0">
        <h4 class="text-xs font-medium text-n-slate-11 mb-2">
          Motivos de pérdida
        </h4>
