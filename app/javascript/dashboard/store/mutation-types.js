export default {
  ...
  // FAQ
  SET_FAQ_UI_FLAG: 'SET_FAQ_UI_FLAG',
  SET_FAQS: 'SET_FAQS',
  ADD_FAQ: 'ADD_FAQ',
  EDIT_FAQ: 'EDIT_FAQ',
  ...
  // Vehicle Brands
  SET_VEHICLE_BRAND_UI_FLAG: 'SET_VEHICLE_BRAND_UI_FLAG',
  SET_VEHICLE_BRANDS: 'SET_VEHICLE_BRANDS',
  ADD_VEHICLE_BRAND: 'ADD_VEHICLE_BRAND',
  EDIT_VEHICLE_BRAND: 'EDIT_VEHICLE_BRAND',
  DELETE_VEHICLE_BRAND: 'DELETE_VEHICLE_BRAND',

  // Vehicle Models
  SET_VEHICLE_MODEL_UI_FLAG: 'SET_VEHICLE_MODEL_UI_FLAG',
  SET_VEHICLE_MODELS: 'SET_VEHICLE_MODELS',
  ADD_VEHICLE_MODEL: 'ADD_VEHICLE_MODEL',
  EDIT_VEHICLE_MODEL: 'EDIT_VEHICLE_MODEL',
  DELETE_VEHICLE_MODEL: 'DELETE_VEHICLE_MODEL',

  // Vehicle Prices
  SET_VEHICLE_PRICE_UI_FLAG: 'SET_VEHICLE_PRICE_UI_FLAG',
  SET_VEHICLE_PRICES: 'SET_VEHICLE_PRICES',
  ADD_VEHICLE_PRICE: 'ADD_VEHICLE_PRICE',
  EDIT_VEHICLE_PRICE: 'EDIT_VEHICLE_PRICE',
  DELETE_VEHICLE_PRICE: 'DELETE_VEHICLE_PRICE',

  // Exchange Rates
  SET_EXCHANGE_RATE_UI_FLAG: 'SET_EXCHANGE_RATE_UI_FLAG',
  SET_EXCHANGE_RATES: 'SET_EXCHANGE_RATES',
  ADD_EXCHANGE_RATE: 'ADD_EXCHANGE_RATE',

  // Romicars Analytics
  SET_ROMICARS_RESOLUTION: 'SET_ROMICARS_RESOLUTION',

  // Bot Logs
  SET_BOT_LOGS: 'SET_BOT_LOGS',
  SET_BOT_LOGS_META: 'SET_BOT_LOGS_META',
  SET_ROMICARS_REQUESTED_PRODUCTS: 'SET_ROMICARS_REQUESTED_PRODUCTS',
